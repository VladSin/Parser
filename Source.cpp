...
void fileRecording(requiredFields parsingData) {
    printf("\n INFO \t\t Saving Data \n");

    ofstream recordData;       
    recordData.open("D:/University/6 semester/Antivirus Methods and Tools/Parser/Data.txt");
...
int main() {
    ...
    if (dosHeader->e_magic == IMAGE_DOS_SIGNATURE) {
        ...
        if (peHeader->Signature == IMAGE_NT_SIGNATURE) {
            ...
            parsingData.exportTableRVA = 0;
            fileRecording(parsingData);
        }   
